...
class RealTimeEngineering(BaseEngineering):
    def __init__(self):
        real_time = True
        super(RealTimeEngineering, self).__init__(real_time)
...
class RealTimeScene(BaseScenesManage):
    def init_node(self):
        camera = CameraReader()
        ...
        self.manage = RealTimeEngineering()


if __name__ == "__main__":
    rt_scene = RealTimeScene()
    rt_scene.start()
